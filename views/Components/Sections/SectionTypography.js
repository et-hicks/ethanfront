        ...
        <div id="images">
          ...
          <GridContainer>
            <GridItem xs={12} sm={2}>
              ...
              /> */}
              <Image src="/public/img/faces/avatar.jpg" alt="..." className={classes.imgRounded + " " + classes.imgFluid} layout="fill" objectFit="contain" />
            </GridItem>
            <GridItem xs={12} sm={2} className={classes.marginLeft}>
              ...
              /> */}
              <Image src="/public/img/faces/avatar.jpg" alt="..." className={classes.imgRoundedCircle + " " + classes.imgFluid} layout="fill" objectFit="contain" />
            </GridItem>
            <GridItem xs={12} sm={2} className={classes.marginLeft}>
              ...
              /> */}
              <Image src="/public/img/faces/avatar.jpg" alt="..." layout="fill" objectFit="contain" className={
                  classes.imgRaised +
                  " " +
                  classes.imgRounded +
                  " " +
